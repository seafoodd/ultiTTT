    ...
    >
      <div className="font-normal mt-2">
        {isSearching ? (
          ...
          <>
            <div className="text-[32px] mb-1 group-hover:text-white transition-colors">
              {timeText}
            </div>
            <div className="text-2xl text-color-neutral-300 group-hover:text-white transition-colors">
              {typeText}
            </div>
          </>
        )}
